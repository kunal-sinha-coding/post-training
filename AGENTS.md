...
- After EVERY change, immediately commit and push the change directly on the configured branch unless the user explicitly specifies another branch. When another branch is explicitly specified, commit and push the branch being used.
